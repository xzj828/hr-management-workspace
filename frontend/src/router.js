  ...
  routes: [
    { path: '/login', name: 'login', component: LoginView, meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'recruitment/tasks', name: 'recruitment-tasks', component: () => import('@/views/recruitment/RecruitmentTasksView.vue'), meta: { module: 'recruitment', recruitmentScope: 'global', resultCenterChild: true, title: '结果中心 · 招聘任务' } },
        { path: 'recruitment/tasks/:planId', name: 'recruitment-task-detail', component: () => import('@/views/recruitment/RecruitmentTaskDetailView.vue'), meta: { module: 'recruitment', recruitmentScope: 'job', hiddenDetail: true, inlineJobContext: true, resultCenterChild: true, title: '结果中心 · 招聘任务' } },
