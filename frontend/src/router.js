  ...
  routes: [
    { path: '/login', name: 'login', component: LoginView, meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'recruitment/tasks/:planId', name: 'recruitment-task-detail', component: () => import('@/views/recruitment/RecruitmentTaskDetailView.vue'), meta: { module: 'recruitment', recruitmentScope: 'job', hiddenDetail: true, inlineJobContext: true, title: '招聘任务详情' } },
