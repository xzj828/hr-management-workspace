...
| 主动寻访批量打招呼 | `RecruitmentResultsView.vue`, `CommunicationConfirmDrawer.vue`, `services/communications.py`, `rpa/boss_chat_bridge.mjs` |
...
8. 主动寻访批量打招呼只接受同岗位、同账号和一份统一话术；每位候选人仍须按平台稳定 ID 逐项核验与留痕。
